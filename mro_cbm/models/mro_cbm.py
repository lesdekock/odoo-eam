...
class MroGauge(models.Model):
    ...
    def create(self, vals):
        ...
        gauge_id = super(MroGauge, self).create(vals)
        values = {
    ...
    def write(self, vals):
        ...
        return super(MroGauge, self).write(vals)
    ...
    def activate_gauge(self):
        for gauge in self:
            vals = {'state': 'reading', 'new_value': gauge.value}
            if gauge.reading_type != 'src': vals['parent_gauge_id'] = False
            self.write(vals)
        return True
...
class MroCbmRule(models.Model):
    ...
    def create(self, vals):
        ...
        return super(MroCbmRule, self).create(vals)
